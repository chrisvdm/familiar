...
const integrationId = (process.env.TEXTY_INTEGRATION_ID || "demo_countdown").trim();
        ...
        body: JSON.stringify({
          ...
          result: {
            ...
            data: {
              ...
              completed_at: completedCountdown?.completed_at || new Date().toISOString(),
            },
          },
        }),
      });
...
server.listen(port, () => {
  console.log(`Async countdown executor listening on http://localhost:${port}`);
});
